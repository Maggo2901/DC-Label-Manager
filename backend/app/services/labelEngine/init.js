...
async function initLabelEngine() {
  ...
  const { LAYOUT_A, LAYOUT_A_QR, LAYOUT_A_RACK, LAYOUT_B, LAYOUT_C } = schemas;
  ...
  registerLayout('layout-a-rack', makeRenderer(LAYOUT_A_RACK), {
    name: 'Standard Cable Label + Rack/RU',
    description: 'A/B side with Rack and RU information in compact DC-style notation.',
    pageDefaults: LAYOUT_A_RACK.page,
    previewColumns: ['Device A', 'Port A', 'Rack A', 'RU A', 'Device B', 'Port B', 'Rack B', 'RU B'],
    zones: { printHalfMm: 25.4 },
  });
