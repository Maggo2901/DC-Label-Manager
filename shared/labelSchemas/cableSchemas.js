...
/* ─── Layout A-Rack — Standard Cable + Rack/RU ──────────────────────── */

/**
 * Segment-Block für Seite A (oberes Segment).
 * Zeile 1: Rack/RU kompakt (optional, computedKey 'rackRuA')
 * Zeile 2: Device-Name (aSide) – primär, fett
 * Zeile 3: Port kompakt 'Pxx' (optional)
 */
export const LAYOUT_A_RACK_BLOCK_A = Object.freeze({
  contentWidthRatio: 0.92,
  paddingTopMm: 2.8,
  positioning: 'flow',
  elements: Object.freeze([
...
/**
 * Segment-Block für Seite B (unteres Segment).
 * Identische Struktur zu Block A, liest jedoch rackB/ruB und zSide/portB.
 */
export const LAYOUT_A_RACK_BLOCK_B = Object.freeze({
  contentWidthRatio: 0.92,
  paddingTopMm: 2.8,
  positioning: 'flow',
  elements: Object.freeze([
...
export const LAYOUT_A_RACK = Object.freeze({
  id: 'layout-a-rack',
  name: 'Standard Cable Label + Rack/RU',
  page: CABLE_PAGE,
  background: LAMINATE_BG,
  segments: Object.freeze([
    { type: 'block', yMm: 0,                heightMm: SEGMENT_HEIGHT_MM, block: LAYOUT_A_RACK_BLOCK_A },
    DIVIDER_SEGMENT,
    { type: 'block', yMm: SEGMENT_HEIGHT_MM, heightMm: SEGMENT_HEIGHT_MM, block: LAYOUT_A_RACK_BLOCK_B },
  ]),
});
